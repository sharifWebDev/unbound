<?php
$page_title = 'Bangladesh Unbound - Coupons Management';
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <img src="assets/img/ico/ico-coupons.svg" alt="Coupons" class="breadcrumb-icon">
                        Coupons Management
                    </li>
                </ol>
            </nav>
            ...
            <div class="coupons-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h3 class="section-title mb-0">
                        <img src="assets/img/ico/ico-coupons.svg" alt="Coupons" class="section-icon">
                        Coupons Management
                    </h3>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <img src="assets/img/ico/ico-coupons.svg" alt="Sign Up" class="modal-icon">
                <h5 class="modal-title text-white" id="addCouponModalLabel">Add New Coupon</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="couponCode" name="couponCode" placeholder="e.g., SUMMER2024" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="couponDescription" name="couponDescription" placeholder="e.g., Summer Special Discount">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="couponValue" name="couponValue" placeholder="0" step="0.01" min="0" required>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="usageLimit" name="usageLimit" placeholder="100" min="1" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="couponActive" name="couponActive" checked>
...
<div class="modal fade" id="editCouponModal" tabindex="-1" aria-labelledby="editCouponModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <img src="assets/img/ico/ico-coupons.svg" alt="Sign Up" class="modal-icon">
                <h5 class="modal-title text-white" id="editCouponModalLabel">Edit Coupon</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editCouponForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="editCouponDescription" name="couponDescription">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="editCouponValue" name="couponValue" step="0.01" min="0" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="editUsageLimit" name="usageLimit" min="1" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="editCouponActive" name="couponActive">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    saveCouponBtn.addEventListener('click', function() {
        ...
        addCouponToTable(code, type, value, limit, expiry, formData.get('couponDescription'), formData.get('couponActive'));
