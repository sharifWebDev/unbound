<?php include 'inc/header.php'; ?>
                        ...
                        <div class="overview-card">
                            <div class="overview-card-header">
                                <div class="overview-icon bookings-icon">
                                    <img src="assets/img/ico/ico-bookings.svg" alt="Bookings" class="overview-icon-img">
                                </div>
                        ...
                        <div class="overview-card">
                            <div class="overview-card-header">
                                <div class="overview-icon spent-icon">
                                    <img src="assets/img/ico/ico-payment.svg" alt="Spent" class="overview-icon-img">
                                </div>
                                <div class="overview-trend positive">
                        ...
                        <div class="overview-card">
                            <div class="overview-card-header">
                                <div class="overview-icon destinations-icon">
                                    <img src="assets/img/ico/ico-map.svg" alt="Destinations" class="overview-icon-img">
                                </div>
                                <div class="overview-trend positive">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="ongoing-bookings.php" class="btn btn-view-details">
                                ...
                                <td class="text-center">
                                    <div class="payment-info">
                                        ...
                                        <button class="btn btn-pay-now mt-2">
                                            Pay Now <img src="assets/img/ico/ico-cart.svg" alt="">
                                        </button>
                                    </div>
                                </td>
                                <td>
            ...
            <div class="mb-4">
                <h3 class="section-title">
                    <img src="assets/img/ico/ico-custom.svg" alt="Custom" class="section-icon">
                    Custom Package/Services Request
                </h3>
                <div class="table-container">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="request-details-customer.php?id=#346GF3W" class="btn btn-view-details">
                                        Details <img src="assets/img/ico/ico-map.svg" alt="">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="assets/img/ico/ico-status.svg" alt="Status" class="table-cell-icon">
                                </td>
                                <td>
                                    <a href="request-details-customer.php?id=#789ABC2" class="btn btn-view-details">
                                        Details <img src="assets/img/ico/ico-map.svg" alt="">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <a href="request-details-customer.php?id=#123DEF4" class="btn btn-view-details">
                                        Details <img src="assets/img/ico/ico-map.svg" alt="">
                                    </a>
                                </td>
                            </tr>
