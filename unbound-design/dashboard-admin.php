                        ...
                        <div class="overview-card">
                            <div class="overview-card-header">
                                <div class="overview-icon orders-icon">
                                    <img src="assets/img/ico/ico-bookings.svg" alt="Orders" class="overview-icon-img">
                                </div>
                        ...
                        <div class="overview-card">
                            <div class="overview-card-header">
                                <div class="overview-icon revenue-icon">
                                    <img src="assets/img/ico/ico-payment.svg" alt="Revenue" class="overview-icon-img">
                                </div>
                                <div class="overview-trend positive">
                                    <i class="bi bi-arrow-up"></i>
                                    <span>+8%</span>
                        ...
                        <div class="overview-card">
                            <div class="overview-card-header">
                                <div class="overview-icon pending-icon">
                                    <img src="assets/img/ico/ico-alert.svg" alt="Pending" class="overview-icon-img">
                                </div>
                ...
                <div class="table-container">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="assets/img/ico/ico-custom.svg" alt="Tour" class="table-cell-icon">
                                    Custom Package
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="guide-info">
                                        <img src="assets/img/avatar.jpg" alt="Customer" class="guide-avatar">
                                        <div>
