                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <div class="search-box">
                            <input type="text" class="form-control" id="searchBookings" placeholder="Search by Order ID, Tour Name, Guide...">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch() {
        ...
        filteredRows = Array.from(tableRows).filter(row => {
            ...
            const guideName = row.querySelector('td:nth-child(7) .fw-semibold')?.textContent.toLowerCase() || '';
