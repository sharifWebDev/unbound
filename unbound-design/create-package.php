            ...
            <div class="create-package-container">
                <form id="createPackageForm" class="package-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control" id="bookingMoney" name="bookingMoney" placeholder="Enter booking money" step="0.01">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="activities-checkboxes">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check activity-checkbox">
                                                    <input class="form-check-input" type="checkbox" id="adventureSports" name="activities[]" value="adventure-sports">
                                                    <label class="form-check-label" for="adventureSports">
                                                        Adventure & Sports
                                                    </label>
                                                </div>
                                                <div class="form-check activity-checkbox">
                                                    <input class="form-check-input" type="checkbox" id="photographyTours" name="activities[]" value="photography-tours">
                                                    <label class="form-check-label" for="photographyTours">
                                                        Photography Tours
                                                    </label>
                                                </div>
                                                <div class="form-check activity-checkbox">
                                                    <input class="form-check-input" type="checkbox" id="religiousSites" name="activities[]" value="religious-sites">
                                                    <label class="form-check-label" for="religiousSites">
                                                        Religious Sites
                                                    </label>
                                                </div>
                                                <div class="form-check activity-checkbox">
                                                    <input class="form-check-input" type="checkbox" id="beachCoastal" name="activities[]" value="beach-coastal">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tourDateFrom" name="tourDateFrom" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="duration" name="duration" placeholder="e.g., 2 Days, 1 Night">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="packageIntro" name="packageIntro" rows="4" placeholder="Enter package introduction"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="tourHighlights" name="tourHighlights" rows="4" placeholder="Enter tour highlights"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="tourAttractions" name="tourAttractions" rows="4" placeholder="Enter tour attractions"></textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="itinerary-container" id="itineraryContainer">
                                        ...
                                        <div class="itinerary-day" data-day="1">
                                            <div class="itinerary-day-header">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-danger remove-itinerary-day" onclick="removeItineraryDay(1)" style="display: none;">
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                            <div id="itineraryDay1Editor" class="rich-text-editor"></div>
                                            <textarea class="form-control d-none" name="itinerary_day_1" rows="3" placeholder="Enter Day 1 itinerary details"></textarea>
                                        </div>
                                    </div>

                                    <!-- Add Day Button -->
                                    <button type="button" class="btn btn-outline-primary mt-3" id="addItineraryDay">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" class="form-control" id="tourMapImage" name="tourMapImage" accept="image/*">
                                    <small class="form-text text-muted">Upload a single tour map image. Supported formats: JPG, PNG, GIF</small>

                                    <!-- Tour Map Image Preview -->
                                    <div class="tour-map-preview mt-3" id="tourMapPreview" style="display: none;">
                                        <div class="tour-map-preview-item">
                                            <img id="tourMapPreviewImg" src="" alt="Tour Map Preview" style="max-width: 300px; max-height: 200px; border-radius: 8px;">
                                            <button type="button" class="btn btn-sm btn-danger mt-2" onclick="removeTourMapPreview()">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="tripNotes" name="tripNotes" rows="4" placeholder="Enter important trip notes"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="faq" name="faq" rows="6" placeholder="Enter frequently asked questions and answers"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="reviews" name="reviews" rows="4" placeholder="Enter customer reviews"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pickupLocation" name="pickupLocation" placeholder="Enter pick up location">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="dropoffLocation" name="dropoffLocation" placeholder="Enter drop off location">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <small class="form-text text-muted">Upload a single featured image. Supported formats: JPG, PNG, GIF</small>
                                        ...
                                        <div class="featured-image-preview mt-3" id="featuredImagePreview" style="display: none;">
                                            <div class="featured-image-preview-item">
                                                <img id="featuredImagePreviewImg" src="" alt="Featured Image Preview" style="max-width: 300px; max-height: 200px; border-radius: 8px;">
                                                <button type="button" class="btn btn-sm btn-danger mt-2" onclick="removeFeaturedImagePreview()">
                                                    <i class="bi bi-trash"></i> Remove
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <small class="form-text text-muted">Upload a single thumbnail image. Supported formats: JPG, PNG, GIF</small>

                                        <!-- Thumbnail Image Preview -->
                                        <div class="thumbnail-image-preview mt-3" id="thumbnailImagePreview" style="display: none;">
                                            <div class="thumbnail-image-preview-item">
                                                <img id="thumbnailImagePreviewImg" src="" alt="Thumbnail Image Preview" style="max-width: 300px; max-height: 200px; border-radius: 8px;">
                                                <button type="button" class="btn btn-sm btn-danger mt-2" onclick="removeThumbnailImagePreview()">
                                                    <i class="bi bi-trash"></i> Remove
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" class="form-control" id="galleryImages" name="galleryImages[]" multiple accept="image/*">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="videoUrl" name="videoUrl" placeholder="Enter YouTube video URL">
                    ...
                    <div class="form-section">
                        ...
                        <div class="activities-logs-container" id="activitiesLogsContainer">
                            ...
                            <div class="activities-log-day" data-day="1">
                                <div class="activities-day-header">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-danger remove-activities-day" onclick="removeActivitiesDay(1)" style="display: none;">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </div>
                                ...
                                <button type="button" class="btn btn-outline-secondary btn-sm mt-2 add-activity-item" data-day="1">
                        ...
                        <!-- Add Day Button -->
                        <button type="button" class="btn btn-outline-primary mt-3" id="addActivitiesDay">
                            <i class="bi bi-plus-circle"></i> Add Day
                        </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addItineraryDayBtn) {
        addItineraryDayBtn.addEventListener('click', function() {
            ...
            quillEditors[`itineraryDay${itineraryDayCount}`] = new Quill(`#itineraryDay${itineraryDayCount}Editor`, {
                theme: 'snow',
                modules: { toolbar: toolbarOptions },
    ...
    if (addActivitiesDayBtn) {
        addActivitiesDayBtn.addEventListener('click', function() {
            ...
            newDay.innerHTML = `
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm mt-2 add-activity-item" data-day="${activitiesDayCount}">
                    <i class="bi bi-plus-circle"></i> Add Feedback
                </button>
            `;
            ...
            if (activitiesDayCount > 1) {
                const allRemoveBtns = activitiesLogsContainer.querySelectorAll('.remove-activities-day');
                allRemoveBtns.forEach((btn, index) => {
                    if (index > 0) { // Don't show for Day 1
                        btn.style.display = 'inline-block';
                    }
                ...
                switch(editorKey) {
                    ...
                    default:
                        ...
                        if (editorKey.startsWith('itineraryDay')) {
                            ...
                            const textarea = document.querySelector(`textarea[name="itinerary_day_${dayNumber}"]`);
                            if (textarea) {
