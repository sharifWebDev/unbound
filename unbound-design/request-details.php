<?php
$page_title = 'Bangladesh Unbound - Request Details';
$page_header = 'Custom Package Request Details';
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <img src="assets/img/ico/ico-custom.svg" alt="Request Details" class="breadcrumb-icon">
                        Request Details
                    </li>
                </ol>
            </nav>
            ...
            <div class="request-details-header mb-4">
                <div class="d-flex align-items-center justify-content-between">
                    <h3 class="section-title mb-0">
                        <img src="assets/img/ico/ico-custom.svg" alt="Request Details" class="section-icon">
                        Request Details
                    </h3>
            ...
            <div class="row g-4 mb-5">
                    ...
                    <div class="info-card">
                        <div class="info-card-header">
                            <h5 class="info-card-title">
                                <img src="assets/img/ico/ico-info.svg" alt="Info" class="info-icon">
                                Basic Information
                            </h5>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="info-card">
                        <div class="info-card-header">
                            <h5 class="info-card-title">
                                <img src="assets/img/ico/ico-users-req.svg" alt="Customer" class="info-icon">
                                Customer Details
                            </h5>
                        </div>
                        <div class="info-card-body">
                            <div class="customer-profile mb-3">
                                <img src="assets/img/avatar.jpg" alt="Customer" class="customer-avatar">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-lg-8">
                    <div class="info-card">
                        <div class="info-card-header">
                            <h5 class="info-card-title">
                                <img src="assets/img/ico/ico-package.svg" alt="Tour" class="info-icon">
                                Tour Preferences
                            </h5>
                        </div>
                        <div class="info-card-body">
                ...
                <div class="col-lg-4">
                    <div class="info-card">
                        <div class="info-card-header">
                            <h5 class="info-card-title">
                                <img src="assets/img/ico/ico-services.svg" alt="Services" class="info-icon">
                                Additional Services
                            </h5>
                        </div>
                        <div class="info-card-body">
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <div class="info-card">
                        <div class="info-card-header">
                            <h5 class="info-card-title">
                                <img src="assets/img/ico/ico-message.svg" alt="Message" class="info-icon">
                                Customer Message
                            </h5>
                        </div>
                        <div class="info-card-body">
                            <div class="customer-message">
                                <p>Hello! I'm planning a cultural tour of Old Dhaka with my family. We're particularly interested in visiting historical sites, local markets, and experiencing authentic Bengali cuisine. We would prefer a guided tour with hotel accommodation and airport pickup/drop-off services. Please let me know the best package options and pricing for our dates.</p>
                                <p>We're flexible with the itinerary but would love to include visits to Lalbagh Fort, Ahsan Manzil, and the spice markets. Looking forward to your response!</p>
                            </div>
                        </div>
                    </div>
                </div>
