 ...
 @section('content')
            ...
            <div class="ongoing-tours-container">
                <!-- Tour Header -->
                <div class="mb-4 tour-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="tour-info">
                                <div class="tour-icon">
                                    <img src="{{ asset('backend/img/ico/ico-package.svg')}}" alt="Tour Icon" class="tour-icon-img">
                                </div>
                                <div class="tour-details">
                                    <h2 class="tour-title">Old Dhaka Tour</h2>
                                    <p class="tour-duration">2 days, 1 night</p>
                                    <div class="mt-2 tour-locations">
                            ...
                            <div class="tour-guide-card">
                                ...
                                <div class="guide-info-card">
                                    <div class="guide-avatar-large">
                                        <img src="{{ asset('backend/img/avatar.jpg')}}" alt="Fahim Bakhtiar" class="guide-img">
                                    </div>
                    ...
                    <div class="progress-header">
                        ...
                        <div class="download-link">
                            <a href="#" class="download-btn">
                                ...
                                <img src="{{ asset('backend/img/ico/ico-download.svg')}}" alt="Download" class="download-icon">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="day-header">
                                ...
                                <div class="download-link">
                                    <a href="#" class="download-btn">
                                        ...
                                        <img src="{{ asset('backend/img/ico/ico-download.svg')}}" alt="Download">
                                    </a>
                                </div>
                            </div>
