 ...
 @section('content')
     ...
     <div class="packages-header">
         <div class="d-flex align-items-center justify-content-between">
             ...
             <a href="create-package" class="btn btn-add-package">
             ...
             <tbody>
                     ...
                     <td>
                         <div class="package-info-cell">
                             <div class="package-image">
                                 <img src="{{ asset('backend/img/ico/ico-package.svg') }}" alt="Sundarbans Adventure"
                                     class="package-img">
                             </div>
                 ...
                 <tr class="package-row">
                     <td>
                         <div class="package-info-cell">
                             <div class="package-image">
                                 <img src="{{ asset('backend/img/ico/ico-package.svg') }}" alt="Cox's Bazar Beach Tour"
                                     class="package-img">
                             </div>
                             <div class="package-details">
                 ...
                 <tr class="package-row">
                     <td>
                         <div class="package-info-cell">
                             <div class="package-image">
                                 <img src="{{ asset('backend/img/ico/ico-package.svg') }}" alt="Sylhet Tea Gardens"
                                     class="package-img">
                             </div>
                             <div class="package-details">
                 ...
                 <tr class="package-row">
                     <td>
                         <div class="package-info-cell">
                             <div class="package-image">
                                 <img src="{{ asset('backend/img/ico/ico-package.svg') }}" alt="Chittagong Hill Tracts"
                                     class="package-img">
                             </div>
                             <div class="package-details">
