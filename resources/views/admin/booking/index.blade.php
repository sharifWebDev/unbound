 ...
 @section('title', 'Bangladesh Unbound - Bookings')
     ...
     <div class="mb-4">
         <div class="mb-3 d-flex justify-content-between align-items-center">
             ...
             <div class="results-info">
                 <span class="text-muted">Showing <span id="showingStart">1</span>-<span id="showingEnd">5</span> of <span
                         id="totalResults">5</span> results</span>
             </div>
         </div>
             ...
             <div class="row align-items-center">
                 <div class="col-md-6">
                     <div class="pagination-info">
                         <span class="text-muted">Showing <span id="paginationStart">1</span> to <span
                                 id="paginationEnd">5</span> of <span id="paginationTotal">5</span> entries</span>
                     </div>
                 </div>
                 <div class="col-md-6">
                     <nav aria-label="Bookings pagination">
                         <ul class="mb-0 pagination justify-content-end" id="paginationControls">
     ...
     <script>
         document.addEventListener('DOMContentLoaded', function() {
             ...
             function updatePagination() {
                 ...
                 prevLi.innerHTML =
                     `<a class="page-link" href="#" id="prevPage"><i class="bi bi-chevron-left"></i> Previous</a>`;
