@extends('layouts.app')
@section('title', 'Bangladesh Unbound - Edit Package')
    ...
    <nav class="breadcrumb-container" aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <img src="{{ asset('backend/img/ico/ico-packages.svg') }}" alt="Edit Package" class="breadcrumb-icon">
                Edit Package
            </li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="p-0 bg-white card">
            <div class="py-3 card-header justify-content-between">
                <h4 class="float-left pt-2 card-title">Update TourPackage</h4>
            </div>
            <div class="container p-4">

                @include('admin.tour_packages.partials.edit-form')
