 ...
 @section('title', 'Bangladesh Unbound - Payment')
 ...
 @section('content')
             ...
             <div class="col-md-4">
                 <div class="search-box">
                     <input type="text" class="form-control" id="searchPendingPayments"
                         placeholder="Search by Order ID, Customer, Tour Name...">
     ...
     <div class="mb-4">
         <div class="mb-3 d-flex justify-content-between align-items-center">
             ...
             <div class="results-info">
                 <span class="text-muted">Showing <span id="pendingShowingStart">1</span>-<span
                         id="pendingShowingEnd">2</span> of <span id="pendingTotalResults">2</span> results</span>
             </div>
         </div>
             ...
             <div class="row align-items-center">
                 <div class="col-md-6">
                     <div class="pagination-info">
                         <span class="text-muted">Showing <span id="pendingPaginationStart">1</span> to <span
                                 id="pendingPaginationEnd">2</span> of <span id="pendingPaginationTotal">2</span>
                             entries</span>
                     </div>
                 </div>
                 <div class="col-md-6">
                     <nav aria-label="Pending payments pagination">
                         <ul class="mb-0 pagination justify-content-end" id="pendingPaginationControls">
     ...
     <div class="mb-4 search-filter-container">
         <div class="row align-items-center">
             <div class="col-md-4">
                 <div class="search-box">
                     <input type="text" class="form-control" id="searchPaymentHistory"
                         placeholder="Search by Transaction ID, Order ID, Tour Name...">
                     <i class="bi bi-search search-icon"></i>
                 </div>
             </div>
             <div class="col-md-2">
     ...
     <div class="mb-4">
         <div class="mb-3 d-flex justify-content-between align-items-center">
             ...
             <div class="results-info">
                 <span class="text-muted">Showing <span id="historyShowingStart">1</span>-<span
                         id="historyShowingEnd">5</span> of <span id="historyTotalResults">5</span> results</span>
             </div>
         </div>
         ...
         <div class="pagination-container pagination-container-padding">
             <div class="row align-items-center">
                 <div class="col-md-6">
                     <div class="pagination-info">
                         <span class="text-muted">Showing <span id="historyPaginationStart">1</span> to <span
                                 id="historyPaginationEnd">5</span> of <span id="historyPaginationTotal">5</span>
                             entries</span>
                     </div>
                 </div>
                 <div class="col-md-6">
                     <nav aria-label="Payment history pagination">
                         <ul class="mb-0 pagination justify-content-end" id="historyPaginationControls">
                             <li class="page-item disabled">
         ...
         document.addEventListener('DOMContentLoaded', function() {
             ...
             function performPendingSearch() {
                 ...
                 pendingFilteredRows = Array.from(pendingTableRows).filter(row => {
                     ...
                     const customerName = row.querySelector('td:nth-child(2) .fw-semibold').textContent
                         .toLowerCase();
             ...
             function updatePendingPagination() {
                 ...
                 prevLi.innerHTML =
                     `<a class="page-link" href="#" id="pendingPrevPage"><i class="bi bi-chevron-left"></i> Previous</a>`;
                 ...
                 nextLi.className =
                     `page-item ${pendingCurrentPage === totalPages || totalPages === 0 ? 'disabled' : ''}`;
                 nextLi.innerHTML =
                     `<a class="page-link" href="#" id="pendingNextPage">Next <i class="bi bi-chevron-right"></i></a>`;
             ...
             function updateHistoryPagination() {
                 ...
                 prevLi.innerHTML =
                     `<a class="page-link" href="#" id="historyPrevPage"><i class="bi bi-chevron-left"></i> Previous</a>`;
                 paginationControls.appendChild(prevLi);
                 ...
                 const nextLi = document.createElement('li');
                 nextLi.className =
                     `page-item ${historyCurrentPage === totalPages || totalPages === 0 ? 'disabled' : ''}`;
                 nextLi.innerHTML =
                     `<a class="page-link" href="#" id="historyNextPage">Next <i class="bi bi-chevron-right"></i></a>`;
                 paginationControls.appendChild(nextLi);
