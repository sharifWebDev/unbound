 @extends('layouts.app')
 @section('title', 'Bangladesh Unbound - Ongoing Tours')
 @section('page-title', 'Ongoing Tours')
 @section('breadcrumb')
    ...
    <nav class="breadcrumb-container" aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <img src="{{ asset('backend/img/ico/ico-ongoing.svg')}}" alt="Ongoing Tours" class="breadcrumb-icon">
                Ongoing Tours
            </li>
        </ol>
    </nav>
                 ...
                 <div class="col-md-8">
                     <div class="order-info-section">
                         <div class="order-icon">
                             <img src="{{ asset('backend/img/ico/ico-package.svg')}}" alt="Tour Icon" class="order-icon-img">
                         </div>
                         <div class="order-details">
                             ...
                             <div class="order-meta">
                                 ...
                                 <div class="mt-3 order-special-discount">
                                     <div class="form-group">
                                         <label for="specialDiscount" class="form-label"><strong>Special
                                                 Discount:</strong></label>
                                         <div class="input-group">
                                             <span class="input-group-text">$</span>
                                             <input type="number" class="form-control" id="specialDiscount"
                                                 name="specialDiscount" placeholder="0.00" step="0.01" min="0">
                                             <button type="button" class="btn btn-outline-success"
                                                 id="applyDiscountBtn">Apply</button>
                                         </div>
                                         <small class="form-text text-muted">Enter discount amount to apply to this
                                             booking</small>
                                     </div>
                                 </div>
                             </div>
                     ...
                     <div class="customer-card">
                         ...
                         <div class="customer-info">
                             <div class="customer-avatar">
                                 <img src="{{ asset('backend/img/avatar.jpg')}}" alt="Fahad Anwar" class="customer-img">
                             </div>
         ...
         <div class="admin-section manage-order-section">
             ...
             <div class="manage-order-form">
                 <div class="order-status-options">
                     ...
                     <div class="form-check">
                         <input class="form-check-input" type="radio" name="orderStatus" id="pending"
                             value="pending">
                     ...
                     <div class="form-check">
                         <input class="form-check-input" type="radio" name="orderStatus" id="cancelled"
                             value="cancelled">
                     ...
                     <div class="form-check">
                         <input class="form-check-input" type="radio" name="orderStatus" id="refunded"
                             value="refunded">
             ...
             <div class="feedback-calendar-form">
                 <div class="form-group">
                     ...
                     <div class="calendar-lock-options">
                         <div class="form-check">
                             <input class="form-check-input" type="radio" name="feedbackCalendarLock"
                                 id="calendarUnlocked" value="no" checked>
         ...
         <div class="modal-dialog modal-dialog-centered">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="text-white modal-title" id="addPaymentModalLabel">
                         <img src="{{ asset('backend/img/ico/ico-payment.svg')}}" alt="Sign Up" class="modal-icon">
                         Add Payment
                     </h5>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-12">
                                 <div class="mb-3 form-group">
                                     ...
                                     <input type="number" class="form-control" id="paymentAmount" placeholder="500"
                                         required>
                                 </div>
                             </div>
                         </div>
         ...
         <div class="modal-dialog modal-dialog-centered">
             <div class="modal-content alert-modal">
                 <div class="text-center modal-body">
                     <div class="mb-2 alert-icon">
                         <img src="{{ asset('backend/img/ico/ico-alert.svg')}}" alt="Alert" class="alert-icon-img">
                     </div>
        ...
        `;
             ...
             if (applyDiscountBtn && specialDiscountInput && amountDueElement) {
                 applyDiscountBtn.addEventListener('click', function() {
                     ...
                     const currentDue = parseFloat(amountDueElement.textContent.replace('$', '').replace(',',
                         '')) || 0;

                     if (discountAmount > 0 && discountAmount <= currentDue) {
                         const newAmount = currentDue - discountAmount;
                         amountDueElement.textContent =
                             `$${newAmount.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}`;
             ...
             if (saveCalendarSettingsBtn) {
                 saveCalendarSettingsBtn.addEventListener('click', function() {
                     const selectedOption = document.querySelector(
                         'input[name="feedbackCalendarLock"]:checked');
